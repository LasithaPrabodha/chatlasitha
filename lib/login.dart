...
import 'package:chat_lasitha/home.dart';
import 'package:chat_lasitha/model/user_chat.dart';
import 'package:chat_lasitha/widget/loading.dart';
    ...
    if (googleUser != null) {
      ...
      if (firebaseUser != null) {
        ...
        if (documents.length == 0) {
          ...
          await prefs?.setString('currStatus', userChat.currStatus);
        }
